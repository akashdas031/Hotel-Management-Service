package com.lcwd.RatingService.ConfigClasses;
...
import com.lcwd.RatingService.ConfigClasses.Interceptors.RestTemplateInterceptor;
...
public class ratingConfiguration {
	...
	@Bean
	public OAuth2AuthorizedClientManager manager(OAuth2AuthorizedClientRepository oauth2AuthorizedClientRepository,
