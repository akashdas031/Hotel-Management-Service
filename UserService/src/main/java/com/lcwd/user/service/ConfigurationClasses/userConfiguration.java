package com.lcwd.user.service.ConfigurationClasses;
...
import com.lcwd.user.service.ConfigurationClasses.Interceptors.RestTemplateInterceptor;
...
public class userConfiguration {
	...
	//declaring oauth2authorization client manager bean
	@Bean
